...
* Remove dangerous permission `REQUEST_INSTALL_PACKAGES` in Android
## 3.2.1
* Add command parser before create system call [#144](https://github.com/crazecoder/open_filez/issues/144) (thanks to [@mludovico](https://github.com/mludovico))
...
* fix [#106](https://github.com/crazecoder/open_filez/issues/106) [#100](https://github.com/crazecoder/open_filez/issues/100) [#74](https://github.com/crazecoder/open_filez/issues/74)
