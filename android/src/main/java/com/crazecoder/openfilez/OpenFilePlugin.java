...
import com.crazecoder.openfilez.utils.JsonUtil;
import com.crazecoder.openfilez.utils.MapUtil;
...
//                    }
    ...
    private void startActivity() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri uri = FileProvider.getUriForFile(context, packageName + ".fileProvider.com.crazecoder.openfilez", new File(filePath));
