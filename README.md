# open_filez
[![pub package](https://img.shields.io/pub/v/open_filez.svg)](https://pub.dev/packages/open_filez)
...
To use this plugin, add [open_filez](https://pub.dev/packages/open_filez/install) as a dependency in your pubspec.yaml file.
```yaml
dependencies:
